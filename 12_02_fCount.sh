...
reads_dir="/mnt/groupMansuy/kerem/tasks/longrna/exp/all_preprocess_01/00_EEbranch/09_02_umidedup_alig_star_sortmerna"


output_folder_main="/mnt/groupMansuy/kerem/tasks/longrna/exp/all_preprocess_01/00_EEbranch/12_02_featCounts_umidedup_alig_star_sortmerna"
...
featureCounts -T $num_threads -s 2 -t exon -g gene_id -a ${genome_dir}/Mus_musculus.GRCm39.109.gtf \
  -o "${output_folder2}/count_gtfE_s02_sortmerna.txt" $(ls $reads_dir/*.bam) > "${log_dir2}/count_gtfE_s02_sortmerna.log" 2>&1

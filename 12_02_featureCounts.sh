...
reads_dir="/mnt/groupMansuy/kerem/tasks/longrna/exp/s2n_preprocess_01/09_02_umidedup_alig_star_sortmerna"

output_folder_main="/mnt/groupMansuy/kerem/tasks/longrna/exp/s2n_preprocess_01"
output_folder0="${output_folder_main}/12_02_featureCounts_umidedup_alig_star_sortmerna"
output_folder1="${output_folder_main}/12_02s1_featureCounts_umidedup_alig_star_sortmerna"
output_folder2="${output_folder_main}/12_02s2_featureCounts_umidedup_alig_star_sortmerna"

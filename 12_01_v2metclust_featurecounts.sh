...
reads_dir="/mnt/groupMansuy/kerem/tasks/longrna/exp/s2n_preprocess_01/09_01_me3_clusterumidedup_alig_star_trim"

output_folder_main="/mnt/groupMansuy/kerem/tasks/longrna/exp/s2n_preprocess_01"
output_folder0="${output_folder_main}/12_01_me3_featureCounts_umidedupclust_alig_star_trim"
output_folder1="${output_folder_main}/12_01s1_me3_featureCounts_umidedupclust_alig_star_trim"
output_folder2="${output_folder_main}/12_01s2_me3_featureCounts_umidedupclust_alig_star_trim"

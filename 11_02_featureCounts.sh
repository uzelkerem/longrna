...
reads_dir="/mnt/groupMansuy/kerem/tasks/longrna/exp/s2n_preprocess_01/08_02_alignment_star_sortmerna"

output_folder_main="/mnt/groupMansuy/kerem/tasks/longrna/exp/s2n_preprocess_01"
output_folder0="${output_folder_main}/11_02_featureCounts_alig_star_sortmerna"
output_folder1="${output_folder_main}/11_02s1_featureCounts_alig_star_sortmerna"
output_folder2="${output_folder_main}/11_02s2_featureCounts_alig_star_sortmerna"

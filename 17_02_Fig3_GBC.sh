...
output_folder="/mnt/groupMansuy/kerem/tasks/longrna/exp/ee_fig3/preprocess_01/_oldbranch/17_02_GeneBodyCov"
...
while IFS= read -r line; do
  ...
  geneBody_coverage.py -r "${genome_dir}/GRCm39_genomic.bed12" -i "$bam_file" -o "${output_folder}/Fig3_results_${sample_name}"

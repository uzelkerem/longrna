...
for i in 1 3 4 6 7 8 9 11 12 14 15 16 18 19 20 21 23 24 26 27 28 29 31 32; do
  file_R1="${input_folder}/EE_HSC${i}_R1.fastq.gz"
  file_R2="${input_folder}/EE_HSC${i}_R2.fastq.gz"
  output_file_R1="${output_folder}/EE_HSC${i}_R1_processed.fastq.gz"
  output_file_R2="${output_folder}/EE_HSC${i}_R2_processed.fastq.gz"
  log_file="${log_dir}/EE_HSC${i}_extraction_log.txt"

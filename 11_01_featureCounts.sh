...
output_folder0="${output_folder_main}/11_01_featureCounts_alig_star_trim"
output_folder1="${output_folder_main}/11_01s1_featureCounts_alig_star_trim"
output_folder2="${output_folder_main}/11_01s2_featureCounts_alig_star_trim"
